package com.rocketmq.trade.coupon.server;
...
public class CouponRestServer {
    public static void main(String[] args) throws Exception {
        // server绑定的端口
        Server server = new Server(TradeEnums.RestEnum.COUPON.getServerPort());
        // 设置全局环境
        ServletContextHandler springContextHandler = new ServletContextHandler();
        springContextHandler.setContextPath("/" + TradeEnums.RestEnum.COUPON.getContextPath());
        // 设置配置的xml文件
